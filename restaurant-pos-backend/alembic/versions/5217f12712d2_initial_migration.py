...
Revision ID: 5217f12712d2
Revises: 
Create Date: 2025-05-01 17:30:19.467037
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'WAITER', 'KITCHEN', 'CASHIER', name='userrole'), nullable=True),
    ...
    sa.Column('order_type', sa.Enum('TABLE', 'DELIVERY', name='ordertype'), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'PREPARING', 'READY', 'DELIVERED', 'CANCELLED', 'PAID', name='orderstatus'), nullable=True),
